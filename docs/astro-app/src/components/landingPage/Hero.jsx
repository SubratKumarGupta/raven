      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-10 md:pt-12 lg:pt-16 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-white  px-8 sm:px-8 md:px-20 lg:px-4">
            ...
            <span className="hidden md:inline">Cogenative AI tool</span>
          </div>
        ...
        >
          <div className="relative w-screen flex justify-center ">
            <div className="w-4/5 2xl:w-[1200px] mx-auto absolute z-10 rounded-xl custom-border-gray hero-dashboard-border-gradient lg:top-6 xl:top-0"></div>
          </div>
        </motion.div>
        <div className="relative w-screen flex justify-center ">
